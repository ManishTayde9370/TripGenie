package com.manish.tripgenie.navigation
...
import com.manish.tripgenie.MainViewModel
import com.manish.tripgenie.MapActivity
import com.manish.tripgenie.ui.screens.*
    ...
    NavHost(
        ...
        composable(Screen.Home.route) {
            HomeScreen(
                ...
                onNavigateToMap = { navController.navigate(Screen.ExploreMap.route) }
            )
        }
        composable(
